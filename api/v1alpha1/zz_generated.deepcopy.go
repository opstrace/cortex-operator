...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CortexConfig.
func (in *CortexConfig) DeepCopy() *CortexConfig {
	if in == nil {
		return nil
	}
	out := new(CortexConfig)
	in.DeepCopyInto(out)
	return out
}
